        ...
        >
          {stats.map((s) => (
            ...
            >
              ...
              />
              <div>
                <div className="hud-caption" style={{ marginBottom: '2px' }}>
                  {s.label}
                </div>
                <div
                  style={{
      ...
      <div style={{ flex: 1 }}>
        ...
        >
          <p style={{ marginBottom: '16px' }}>
            I'm a UX/UI designer and web developer based in Seoul, combining
            design precision with technical craft. I build digital experiences
            that feel alive — from interactive web apps to immersive 3D
            interfaces.
          </p>
