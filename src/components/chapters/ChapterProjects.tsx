...
const projects = [
  ...
  },
  {
    ...
    stack: ['JavaScript', 'Canvas', 'Pixel Art'],
    href: 'https://www.isomaker.fr/',
  },
  {
    year: '2023',
    title: 'LibertAI',
    ...
    role: 'Freelance Frontend Dev & Designer',
    stack: ['React', 'UI/UX', 'Accessibility'],
      ...
      <div style={{ flex: '0 0 30%', maxWidth: '30%', paddingTop: '4px' }}>
        ...
        >
          ...
          <p style={{ fontSize: '0.85rem', marginBottom: '24px' }}>
            Interactive applications spanning design, development, and user
            experience.
          </p>
          <a
            href="/projects"
