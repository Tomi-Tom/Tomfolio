...
import SceneAbout from '../Three/SceneAbout'
...
export default function PresentationSection(): ReactElement {
  ...
  return (
    <section className="py-24 section-dark relative overflow-hidden" ref={sectionRef}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          >
            <motion.div variants={itemVariants}>
              <h2 className="!text-accent font-semibold text-sm uppercase tracking-wider mb-2">About Me</h2>
              <h3 className="text-4xl md:text-5xl text-on-dark font-bold">A passion for creating <span className="brand-tt">meaningful</span> digital experiences</h3>
            </motion.div>

            <motion.p
              className="text-lg text-on-dark-secondary leading-relaxed"
            ...
            <motion.div
              className="h-px w-full bg-on-dark-secondary/20"
              variants={itemVariants}
              initial={{ width: 0 }}
              animate={controls}
            ...
            >
              {[
                ...
                >
                  {item.icon}
                  <div>
                    <p className="text-sm text-on-dark-secondary">{item.label}</p>
