...
const Card = ({ title, description, image, link, github }) => {
  return (
    <div className="group relative h-56 min-w-64">
      <div className="size-full rounded-xl border border-border-1 bg-solid-1 transition-all duration-300 group-hover:-translate-y-5 group-hover:scale-110 group-hover:bg-interactive-2 group-hover:shadow-lg">
        <div
        ...
        <div className="group/base w-full">
          ...
          <div className="absolute bottom-0 left-1/4 flex justify-center gap-4 rounded-b-xl p-2 opacity-0 transition-all duration-300 group-hover/base:-translate-y-2 group-hover/base:opacity-100">
            {link ? (
              <button
